  ...
  return (
    <div className={s.container}>
        ...
        <div className={s.filters}>
         ...
         {openPicker && <DatePicker closePicker={() => setOpenPicker(false)} date={date} month={date.month} year={date.year} handleClick={handleClick} prevYear={prevYear} nextYear={nextYear} monthNames={monthNames}/>}
    </div>
  )
}
